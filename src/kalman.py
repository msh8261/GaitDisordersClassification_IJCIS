"""
link of code:
https://github.com/Team-Neighborhood/Kalman-Filter-Image/blob/master/kalman.py
"""
...
class KF2d:
    ...
    def __init__(self, dt=1):
        ...
        self.R = np.array([[100, 0], [0, 100]], dtype=np.float)
    ...
    def kalman_main(self, x, P, z):
        ...
        HPHR = HPH + self.R
        inv_HPHR = np.array([[HPHR[1, 1], -HPHR[0, 1]], [-HPHR[1, 0], HPHR[0, 0]]])
